...
public class SupplierContractController {
    ...
    public ResponseEntity<ApiResponse<Page<SupplierContractDto.ListResponse>>> getAll(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contracts retrieved successfully", supplierContractService.getAllContracts(pageable)));
    }

    @GetMapping("/supplier/{supplierId}")
    public ResponseEntity<ApiResponse<List<SupplierContractDto.ListResponse>>> getBySupplier(
            @PathVariable String supplierId) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contracts retrieved successfully", supplierContractService.getBySupplier(supplierId)));
    }

    @GetMapping("/status/{status}")
    public ResponseEntity<ApiResponse<Page<SupplierContractDto.ListResponse>>> getByStatus(
            @PathVariable String status, Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contracts retrieved successfully", supplierContractService.getByStatus(status, pageable)));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<SupplierContractDto.Response>> getById(@PathVariable String id) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contract retrieved successfully", supplierContractService.getContract(id)));
    }
    ...
    public ResponseEntity<ApiResponse<List<SupplierContractDto.ListResponse>>> getExpiring(
        ...
        return ResponseEntity.ok(ApiResponse.success("Expiring contracts retrieved successfully", supplierContractService.getExpiringContracts(days)));
    }
    ...
    public ResponseEntity<ApiResponse<SupplierContractDto.Response>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
            .body(ApiResponse.success("Supplier contract created successfully", supplierContractService.createContract(request)));
    }
    ...
    public ResponseEntity<ApiResponse<SupplierContractDto.Response>> update(
            ...
            @Valid @RequestBody SupplierContractDto.Request request) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contract updated successfully", supplierContractService.updateContract(id, request)));
    }
    ...
    public ResponseEntity<ApiResponse<SupplierContractDto.Response>> activate(@PathVariable String id) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contract activated successfully", supplierContractService.activateContract(id)));
    }

    @PostMapping("/{id}/terminate")
    public ResponseEntity<ApiResponse<SupplierContractDto.Response>> terminate(@PathVariable String id) {
        return ResponseEntity.ok(ApiResponse.success("Supplier contract terminated successfully", supplierContractService.terminateContract(id)));
    }
}
